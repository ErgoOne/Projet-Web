  ...
  <head>
    ...
    <div id="cadre-container">
          ...
          <div id= "cadre">
            ...
            <img id= "pirate1" src="images/ile.png" alt= "pirate">
            <img id= "pirate2" src="images/ile.png" alt= "pirate">
            <img id= "port1" src="images/port-gauche.png" alt="port1"> 
            <img id= "port2" src="images/port-droit.png" alt="port2"> 
          ...
          <div id= "actions_tour">
             ...
             <div id= "texte_case_pirate">Vous ne pouvez pas vous déplacer sur un port</div>
              ...
              <br><input type= "button" id= "annuler" value= "Annuler" onclick= "annuler();">
              <br><input type= "button" id= "bouton_deplacer_bateau1" value= "Deplacer_Bateau" onclick="deplacer_bateau();"><br>
              <!-- <br><input type= "button" id= "bouton_attaquer" value= "Attaquer" onclick="attaquer_bateau();"><br>     -->
          
            </div id= "bouton_finir_gagner">
              <input type= "button" id= "finir_tour" value= "Finir_tour" onclick="finir_tour();">           
              <a type= "button" id= "victoire" href="hid.victoire.php">Victoire</a> 
            </div>
